	...
	<div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
		...
		<div class="max-w-4xl mx-auto">
			...
			<div class="grid grid-cols-3 lg:grid-cols-6 gap-4 justify-items-center">
				<img class="h-7" src="{{ asset('img/company/google.svg') }}">
				<img class="h-7" src="{{ asset('img/company/netflix.svg') }}">
				<img class="h-7" src="{{ asset('img/company/airbnb.svg') }}">
				<img class="h-7 transform translate-y-2" src="{{ asset('img/company/amazon.svg') }}">
				<img class="h-7" src="{{ asset('img/company/facebook.svg') }}">
				<img class="h-7" src="{{ asset('img/company/grab.svg') }}">
			</div>
		</div>
		...
		<div class="mt-28">
			...
			<div data-aos="fade-up" class="flex flex-col md:flex-row justify-center space-y-5 md:space-y-0 md:space-x-6 lg:space-x-10 mt-7">
				<div class="relative md:w-5/12">
					<img class="rounded-2xl" src="{{ asset('img/Rectangle 19.png') }}" alt="">
				...
				<div class="relative md:w-5/12">
					<img class="rounded-2xl" src="{{ asset('img/Rectangle 21.png') }}" alt="">
					<div class="absolute bg-black bg-opacity-20 bottom-0 left-0 right-0 w-full h-full rounded-2xl">
						<div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
